...
import com.kuyou.avc.basic.ringtone.LocalRingtonePlayer;
import com.kuyou.avc.basic.ringtone.RingtonePlayer;
...
public class PeergineAudioVideoHandler extends AudioVideoRequestResultHandler {
    ...
    public RingtonePlayer getRingtonePlayer() {
        if (null == mRingtonePlayer) {
            mRingtonePlayer = new LocalRingtonePlayer(getContext());
        }
    ...
    public void setHandleStatus(int handlerStatus) {
        ...
        if (HS_OPEN_REQUEST_BE_EXECUTING == handlerStatus) {
            getRingtonePlayer().play();
        } else {
            getRingtonePlayer().stop();
        }
