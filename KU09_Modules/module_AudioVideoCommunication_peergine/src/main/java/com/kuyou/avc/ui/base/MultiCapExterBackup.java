...
public class MultiCapExterBackup extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private pgLibLiveMultiCapture.OnEventListener m_OnEvent = new pgLibLiveMultiCapture.OnEventListener() {
        ...
        public void event(String sAct, String sData, String sRenID) {
            ...
            if (sAct.equals("VideoStatus")) {
                ...
                Toast.makeText(MultiCapExterBackup.this, sInfo, Toast.LENGTH_SHORT).show();
    ...
    public static void outString(String str) {
        if (MultiCapExterBackup.m_sDebug.getText().length() > 600) {
            MultiCapExterBackup.m_sDebug.setText("");
        }
        MultiCapExterBackup.m_sDebug.setText(MultiCapExterBackup.m_sDebug.getText() + "  " + str);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_capexter);
