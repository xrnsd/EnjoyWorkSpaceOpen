...
public class MultiRenderBackup extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public static void outString(String str) {
        if (MultiRenderBackup.m_sDebug.getText().length() > 600) {
            MultiRenderBackup.m_sDebug.setText("");
        }
        MultiRenderBackup.m_sDebug.setText(MultiRenderBackup.m_sDebug.getText() + "  " + str);
    }
    ...
    private pgLibLiveMultiRender.OnEventListener m_OnEvent = new pgLibLiveMultiRender.OnEventListener() {
        ...
        public void event(String sAct, String sData, String sCapID) {
            ...
            if (sAct.equals("VideoStatus")) {
                ...
                Toast.makeText(MultiRenderBackup.this, sInfo, Toast.LENGTH_SHORT).show();
                ...
                if (iInd >= 0) {
                    ...
                    Toast.makeText(MultiRenderBackup.this, ("Delta:" + iDelta), Toast.LENGTH_SHORT).show();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_render);
    ...
    protected void onStart() {
        super.onStart();
        m_Live.LoginNow(0);
        Toast.makeText(MultiRenderBackup.this, "Enter foreground, login now", Toast.LENGTH_SHORT).show();
    }
    ...
    private void btnSend() {
        ...
        Log.d("pgLiveRander", "btnSend: sMsg = " + sMsg);
    ...
    private void btnPut() {
        ...
        if (iErr > 0) {
            Log.d("pgLiveRander", "btnPut: iErr = " + iErr);
    ...
    private void btnGet() {
        ...
        if (iErr > 0) {
            Log.d("pgLiveRander", "btnGet: iErr = " + iErr);
    ...
    private void btnCancel() {
        ...
        if (iErr > 0) {
            Log.d("pgLiveRander", "btnCancel: iErr = " + iErr);
        } else {
            setTransfering(false);
