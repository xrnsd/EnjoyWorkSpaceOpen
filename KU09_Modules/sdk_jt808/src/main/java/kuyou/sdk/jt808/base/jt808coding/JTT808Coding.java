...
import kuyou.common.ku09.bytes.BCD8421Operater;
...
public class JTT808Coding {
     ...
     * @return
     */
    public static byte[] generate808(int msgId, Jt808Config config, byte[] msgBody) {
     ...
     * @param pkgNo      当前序号
     */
    public static byte[] generate808(int msgId, Jt808Config config, byte[] msgBody, int subpackage, long totalPkg, long pkgNo) {
    ...
    public static Generate808andSeqBean generate808orSeqNo(int msgId, Jt808Config config, byte[] msgBody) {
     ...
     * @return 包装好的数据和消息序号
     */
    public static Generate808andSeqBean generate808orSeqNo(int msgId, Jt808Config config, byte[] msgBody, int subpackage, long totalPkg, long pkgNo) {
    ...
    private static byte[] msgBodyAttributes(int msgLength, int subpackage) {
        ...
        String encryption = Jt808Config.Header.ENCRYPT;
        //[13]分包
        String subpackageB = String.valueOf(subpackage);
        //[14,15]保留位
        String reserve = Jt808Config.Header.RESERVE;
