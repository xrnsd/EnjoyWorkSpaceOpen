...
import kuyou.sdk.jt808.oksocket.core.exceptions.WriteException;
import kuyou.sdk.jt808.oksocket.core.iocore.interfaces.IIOCoreOptions;
import kuyou.sdk.jt808.oksocket.core.iocore.interfaces.IOAction;
    ...
    public boolean write() throws RuntimeException {
        ...
        if (sendable != null) {
            try {
                ...
                //android.util.Log.d("kuyou.sdk.jt808 >"," sendBytes > "+ ByteUtils.bytes2Hex(sendBytes));
                ...
                while (remainingCount > 0) {
                    ...
                    if (SLog.isDebug()) {
                        ...
                        SLog.i("write bytes: " + ByteUtils.bytes2Hex(forLogBytes));
