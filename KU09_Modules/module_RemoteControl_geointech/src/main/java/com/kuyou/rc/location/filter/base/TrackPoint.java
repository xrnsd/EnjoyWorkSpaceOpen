package com.kuyou.rc.location.filter.base;
...
public class TrackPoint {
    ...
    public void applyTrackPoint(TrackPoint point) {
        if (null == point) {
            Log.e(TAG, "applyTrackPoint fail > TrackPoint is null");
            return;
        }
    ...
    public Location toLocation() {
        if (null == sLocation) {
            sLocation = new Location("TrackPoint");
        }
        sLocation.setLatitude(getLatitude());
        sLocation.setLongitude(getLongitude());
        return sLocation;
    }
}
