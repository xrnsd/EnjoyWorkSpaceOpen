...
import com.kuyou.rc.location.base.ILocationProviderLiveCallback;
 ...
 * </p>
 */
public class AMapLocationProvider extends HMLocationProvider
        implements ILocationProviderLiveCallback,
    ...
    @Override
    protected void init() {
        initGaoDeLocationSDK(getContext().getApplicationContext());
    }
    ...
    public void startLocation(boolean isBackground) {
        ...
        if (isBackground) {
            locationClient.enableBackgroundLocation(2001, buildNotification(getContext()));
        }
    }
    ...
    public void onLocationChanged(AMapLocation location) {
        if (null == location) {
            Log.w(TAG, "AMapLocationListener > onLocationChanged > 定位失败 > use base location ");
            return;
        }
    ...
    private void printfAMapLocationInfo(AMapLocation location) {
        ...
        Log.i(" HM 808 > Location ", sb.toString());
    }
