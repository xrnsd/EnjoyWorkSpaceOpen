package com.kuyou.openlive.rtc;
...
public class AgoraEventHandler extends IRtcEngineEventHandler {
    ...
    private onAgoraError mErrorListener;
    ...
    public void onConnectionStateChanged(int state, int reason) {
        if (null != mErrorListener)
            mErrorListener.onConnectionStateChanged(state, reason);
        super.onConnectionStateChanged(state, reason);
    }

    public void setOnAgoraError(onAgoraError listener) {
        mErrorListener = listener;
    }

    public static interface onAgoraError {
        public void onError(int err);
