...
import com.kuyou.openlive.utils.WindowUtil;
...
public abstract class BaseLiveActivity extends BasePermissionsActivity implements EventHandler {
    ...
    protected abstract void initLiveConfig();

    protected abstract VideoGridContainer getVideoGridContainer();
