...
public class TestItemUWB extends TestItemBasic {
    ...
    protected int getHardwareModuleTypeId() {
        return IHardwareDetection.HM_TYPE_INPUT_LOCATION_UWB;
    }
            ...
            case EventRemoteControl.Code.HARDWARE_MODULE_STATUS_DETECTION_RESULT:
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mBtnSuccess.setEnabled(IHardwareDetection.HM_STATUS_BE_EQUIPPED_NORMAL
    ...
    protected void onReceiveProcessStatusNotice(int statusCode, boolean isRemove) {
        ...
        switch (statusCode) {
            case PS_MODULE_DETECTION_TIME_OUT:
                ...
                int statusId = getDeviceConfig().isHardwareModuleCarry(IHardwareDetection.HM_TYPE_INPUT_LOCATION_UWB) ?
                        IHardwareDetection.HM_STATUS_BE_EQUIPPED_NOT_DETECTED : IHardwareDetection.HM_STATUS_NOT_EQUIPPED;
    ...
    protected void start() {
        ...
        dispatchEvent(new EventHardwareModuleStatusDetectionRequest()
                .setTypeId(IHardwareDetection.HM_TYPE_INPUT_LOCATION_UWB)
                .setRemote(true));
