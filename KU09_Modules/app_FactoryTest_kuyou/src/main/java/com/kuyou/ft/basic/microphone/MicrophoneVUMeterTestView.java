...
package com.kuyou.ft.basic.microphone;
...
public class MicrophoneVUMeterTestView extends View {
    ...
    /**
     * constructor of MicrophoneVUMeterTestView
     *
     * @param context the context that show MicrophoneVUMeterTestView
     */
    public MicrophoneVUMeterTestView(Context context) {
        super(context);
        mContext = context;
        init();
    }
     ...
     */
    public MicrophoneVUMeterTestView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    /**
     * set Recorder that bind with this MicrophoneVUMeterTestView
     *
     * @param recorder Recorder to be set
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null != mRecorder
                && mRecorder.mState == mRecorder.RECORD_STATE_RECORDING) {
