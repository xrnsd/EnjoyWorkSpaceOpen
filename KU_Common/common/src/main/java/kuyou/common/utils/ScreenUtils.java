...
public class ScreenUtils {
    private static final String TAG = "kuyou.common.utils > ScreenUtils";
    ...
    public static void ScreenInfo(Context context) {
        ...
        Log.e(TAG, "Density is " + displayMetrics.density + " densityDpi is " + displayMetrics.densityDpi + " height: " + displayMetrics.heightPixels + " width: " + displayMetrics.widthPixels);
...
//        System.out.println(statusBarHeight);
        ...
        String brand = Build.BRAND;//获得手机品牌
        Bitmap b = null;
