...
public class LauncherThemeBroadcastReceiver extends BroadcastReceiver implements Itheme {
    ...
    private static final String TAG = "kuyou.common.theme > LauncherThemeBroadcastReceiver";
                ...
                case ACTION:
                    if (mLauncherThemeListener != null) {
                        ...
                        if (intent.hasExtra(KEY))
                            ...
                            android.util.Log.d(TAG, "onReceive onThemeChange:" + "null themeid");
                    }
                    break;
                case ACTION_FINISH:
                    if (mLauncherThemeFinishListener != null) {
                        if (intent.hasExtra(KEY))
                            ...
                            android.util.Log.d(TAG, "onReceive onThemeChangeFinish:" + "null themeid");
                    }
                    break;
            }
            android.util.Log.d(TAG, "onReceive onThemeChange:" + ACTION);
        }
    }
    ...
    public static void unregisterLauncherThemeReceiver(Context context) {
        try {
            ...
            android.util.Log.e(TAG, "unregisterLauncherThemeReceiver=" + e);
        }
    }
