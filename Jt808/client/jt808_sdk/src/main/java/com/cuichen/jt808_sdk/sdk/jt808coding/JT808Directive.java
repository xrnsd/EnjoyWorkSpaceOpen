...
//        byte[] state = {0, 0, 0, 0};
        ...
        //bcd时间
        byte[] bcdTime = ByteUtil.str2Bcd(time);
        //位置信息附加项
        ...
        //return ByteUtil.byteMergerAll(alarm, state, latb, lngb, gaoChen, speedb, orientation, bcdTime);
        //return ByteUtil.byteMergerAll(alarm, state, latb, lngb, gaoChen, speedb, orientation);
    }
...
//     * 上传图片
//     */
//    public static List<byte[]> uploadImage(String phone, Location location, byte[] imageBytes) {
//        List<byte[]> allMsgBytesList = new ArrayList<byte[]>();
//
//        byte[] id = ByteUtil.longToDword(System.currentTimeMillis());
//        byte[] type = {0, 0, 0, 0};//文件类型,文件格式,事件类型,通道ID
//        byte[] locationBytes = reportLatLng(location.getLatitude(), location.getLongitude());
//
...
//            if (i == 1) {
//                byte[] allData = ByteUtil.byteMergerAll(id, type, locationBytes, bytes);
//                sendByte = JTT808Coding.generate808(0x0801, phone,
//                        allData, 1, totalPkg, i);
//            } else {
//                sendByte = JTT808Coding.generate808(0x0801, phone,
//                        bytes, 1, totalPkg, i);
//            }
//            allMsgBytesList.add(sendByte);
//        }
//        return allMsgBytesList;
//    }
