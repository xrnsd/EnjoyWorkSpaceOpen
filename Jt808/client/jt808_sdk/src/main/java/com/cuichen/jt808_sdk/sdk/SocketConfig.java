...
public class SocketConfig {
    ...
    public static String  socketIp = "centos40.geointech.cn" ;// IpUtils.getIPAddress(APP.mC);
    public static String  socketPort = "8110" ;
    ...
    //心跳间隔
    public static int HEARTBEAT_INTERVAL = 10*1000;
    //本地保存鉴权码的KEY
