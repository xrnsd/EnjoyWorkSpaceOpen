package com.kuyou.jt808.service;
...
import com.kuyou.jt808.service.service_interface.OnJt808LocationBackList;
import com.kuyou.jt808.service.service_interface.OnServiceWorking;
...
public class Jt808SocketKeepService implements KeepLiveService {
    ...
    public void onWorking() {
        if (socketManager == null) {
            ...
            socketManager.init(Jt808Application.mC);
        }
    ...
    public void startLocation(final OnJt808LocationBackList onJt808LocationBackList) {
        ...
        socketManager.startLocation(new StartLocationBackList() {
            ...
            public void onBack(int code, String msg) {
              if (code == 0){
                  getLocationListener(Jt808Application.mC , 5000,false);
              }
